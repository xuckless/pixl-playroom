...
export function BrushOptions(): React.JSX.Element | null {
  ...
  return (
    <div className="tool-options">
      ...
      <Toggle on={brush.erase} onChange={(erase) => setBrush({ erase })} title="Erase (hold Alt)">
        Erase
      </Toggle>
      <span className="muted small">[ ] size · Alt erases</span>
    </div>
  )
}
